...
wget https://www.robots.ox.ac.uk/~vgg/data/oxbuildings/oxbuild_images.tgz --no-check-certificat
tar -xzvf oxbuild_images.tgz
wget https://www.robots.ox.ac.uk/~vgg/data/oxbuildings/gt_files_170407.tgz --no-check-certificat
